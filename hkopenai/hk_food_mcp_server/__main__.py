...
import argparse
import os
from hkopenai.hk_food_mcp_server.server import server

def cli_main():
    parser = argparse.ArgumentParser(description="HK Food MCP Server")
    parser.add_argument(
    ...
    server(host=host_final, port=port_final, sse=sse_final)
