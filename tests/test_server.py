...
class TestApp(unittest.TestCase):
    ...
    @patch('hkopenai.hk_food_mcp_server.server.tool_wholesale_prices_of_major_fresh_food')
    def test_create_mcp_server(self, mock_tool_wholesale_prices_of_major_fresh_food, mock_fastmcp):
        # Setup mocks
        mock_server = Mock()
        ...
        decorated_funcs['get_wholesale_prices'](start_date="01/01/2023", end_date="31/01/2023", language="en")
        mock_tool_wholesale_prices_of_major_fresh_food.get_wholesale_prices.assert_called_once_with("01/01/2023", "31/01/2023", "en")
